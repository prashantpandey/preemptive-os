...
sched_yield(void)
{
        ...
        // runnable environments other than the idle environments and pp_dedup,
        // drop into the kernel monitor or run the post-process dedup
        // module based on INLINE_DEDUP macro.
        for (i = 0; i < NENV; i++) {
